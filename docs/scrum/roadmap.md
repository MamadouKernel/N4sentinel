...
| 3 | Mode simulation & préparation | E1.5 Test connectivité sans action mutative (5) · E3.1 Mode simulation (8) · E2.1 Sélection de scénario (5) | 18 | À faire |
...
**Total V1 : 257 points sur 15 sprints** (3 faits, 12 à faire), soit environ **6-7 mois** au rythme de 2
