...
public class ResumeOperationRunCommandHandlerTests
{
    ...
    private ResumeOperationRunCommandHandler CreateHandler() => new(operationRuns, unitOfWork);

    private static OperationRun CreateFailedRun()
    {
    ...
    [Fact]
    public async Task Handle_FailedRun_ResumesAndSaves()
    {
